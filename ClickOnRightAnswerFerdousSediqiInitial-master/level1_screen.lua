...
-----------------------------------------------------------------------------------------
    ...
    local youLost = audio.loadSound("Sounds/WrongBuzzerOld.mp3")
    local youWin =audio.loadSound("Sounds/Kids Booing.mp3")
    local youWinChannel
...
local function DetermineAnswers()
    ...
    wrongAnswer4 = answer + math.random(13,16)
...
local function TouchListenerWrongAnswer4(touch)
    -- get the user answer from the text object that was clicked on
    local userAnswer = wrongAnswer4TextObject.text
...
local function AddTextObjectListeners()
    ...
    wrongAnswer4TextObject:addEventListener("touch", TouchListenerWrongAnswer4)
end
...
local function RemoveTextObjectListeners()
    ...
    wrongAnswer4TextObject:removeEventListener("touch", TouchListenerWrongAnswer4)
end
...
function scene:create( event )
    ...
    addEquationTextObject = display.newText( "", display.contentWidth*1/4, display.contentHeight*2/3, nil, 90 )

    -- sets the color of the add equation text object
    addEquationTextObject:setTextColor(2005/255, 42/255, 208/255)
    ...
    wrongAnswer4TextObject = display.newText("", display.contentWidth*.5, display.contentHeight/2, nil, 50 )
    ...
    correct.isVisible = false
     ...
     -- create the text object that will say Correct, set the colour and then hide it
    incorrect = display.newText("Inncorect", display.contentWidth/2, display.contentHeight*1/3, nil, 50)
    ...
    outOfTimeText = display.newText("Out of Time!", display.contentWidth*2/5,
     display.contentHeight*1/3, nil, 50)
    ...
    sceneGroup:insert( wrongAnswer4TextObject )
